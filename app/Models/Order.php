...
class Order extends Model
{
    ...
    public function statistics(Request $request)
    {
        ...
        // Get writer profile using the relationship
        $user->writerProfile; // This will eager load the relationship
     ...
     * @return array
     */
    protected function calculateWriterRating($user)
    {
        // Implement your rating calculation logic here
        $rating = 0;
        if ($user->writerProfile && $user->writerProfile->rating) {
            $rating = $user->writerProfile->rating;
        }
        
        return [
            'rating' => $rating,
            'count' => 0, // You can add actual count logic here
            'details' => [] // You can add rating details here
        ];
    }
